...
public class MyCnnModel
{
    /**
     * Location to the training/testing data
     */
    public static final String DATA_PATH = FilenameUtils.concat(System.getProperty("java.io.tmpdir"), "dl4j_w2vSentiment/");
    /**
     * Location (local file system) for the Archeage vectors.
     */
    public static final String WORD_VECTORS_PATH = "w2vectors_Archeage.bin";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String pathFirstNegativeFile = FilenameUtils.concat(DATA_PATH, "TwitterDataset/test/neg/0.txt");
    ...
    private static DataSetIterator getDataSetIterator(boolean isTraining, WordVectors wordVectors, int minibatchSize,
        ...
        String path = FilenameUtils.concat(DATA_PATH, (isTraining ? "TwitterDataset/train/" : "TwitterDataset/test/"));
